    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!favorites.isEmpty()) {
            for (int i = 0; i < favorites.size(); i++) {
                ...
                NewsItem tempItem = new NewsItem(tempFavorites.getImageURL(), tempFavorites.getNewsURL(), tempFavorites.getTitle(), tempFavorites.getSource(), tempFavorites.getUserName());
